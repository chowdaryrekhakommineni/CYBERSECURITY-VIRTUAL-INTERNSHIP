...
**Internship Title:** Cybersecurity Virtual Internship  
...
- Understood the fundamentals of **Cybersecurity and Network Defense**.  
- Gained exposure to **threat prevention techniques** and **incident handling**.  
- Learned about **firewall configuration, endpoint protection,** and **security automation**.  
- Completed practical labs and case studies through the **Palo Alto Networks Learning Platform**.
...
🔗 **Trailblazer Profile:** Salesforce Trailhead  
...
> *"Empowering youth through technology and cybersecurity awareness for a safer digital future."*
